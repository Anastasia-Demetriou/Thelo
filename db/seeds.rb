...
louise = User.create!(first_name: "Louise", last_name:"Jones", email:"louise@gmail.com", password:"password", professional: true, bio:"Experienced Chef")
john = User.create!(first_name: "John", last_name:"Doe", email:"johndoe@gmail.com", password:"password", professional: true, bio:"Experienced Waiter")
andrew = User.create!(first_name: "Andrew", last_name:"Smith", email:"andrewsmith@gmail.com", password:"password", professional: true, bio:"Experienced Mixologist")
lisa = User.create!(first_name: "Lisa", last_name:"Cooper", email:"lisa@gmail.com", password:"password", professional: false, bio:"")
rob = User.create!(first_name: "Rob", last_name:"Forbs", email:"rob@gmail.com", password:"password", professional: false, bio:"")
steve = User.create!(first_name: "Steve", last_name:"Jenkins", email:"steve@gmail.com", password:"password", professional: false, bio:"")
meghan = User.create!(first_name: "Meghan", last_name:"Wiseman", email:"meghan@gmail.com", password:"password", professional: false, bio:"")
julia = User.create!(first_name: "Julia", last_name:"Hawkins", email:"julia@gmail.com", password:"password", professional: false, bio:"")
irene = User.create!(first_name: "Irene", last_name:"Mendez", email:"irene@gmail.com", password:"password", professional: false, bio:"")
james = User.create!(first_name: "james", last_name:"Ward", email:"james@gmail.com", password:"password", professional: false, bio:"")
jack = User.create!(first_name: "jack", last_name:"Styles", email:"jack@gmail.com", password:"password", professional: false, bio:"")
...
event3 =  Event.create!(name:"Casual Dinner", date:"2018/12/18", event_type: "dinner", location:"Liverpool", description:"", party_size: 40, service: waiter, min_price: 100, max_price: 150, user_id: andrew.id)
...
event7 =  Event.create!(name:"Birthday Dinner", date:"2018/01/19", event_type: "birthday", location:"London", description:"", party_size: 10, service: chef, min_price: 1, max_price: 5, user_id: andrew.id)
...
event10 =  Event.create!(name:"Birthday party", date:"2018/12/29", event_type: "party", location:"London", description:"", party_size: 17, service: chef, min_price: 100, max_price: 250, user_id: andrew.id)
event12 =  Event.create!(name:"Reunion Dinner", date:"2018/12/05", event_type: "Dinner", location:"London", description:"", party_size: 10, service: chef, min_price: 250, max_price: 400, user_id: louise.id)
event13 =  Event.create!(name:"30th Birthday!", date:"2018/12/19", event_type: "birthday", location:"London", description:"", party_size: 13, service: mixologist, min_price: 150, max_price: 250, user_id: andrew.id)
event14 =  Event.create!(name:"Fred's Farewell", date:"2018/12/17", event_type: "family event", location:"London", description:"", party_size: 10, service: chef, min_price: 150, max_price: 300, user_id: andrew.id)
event15 =  Event.create!(name:"Welcome Home party", date:"2018/12/10", event_type: "family event", location:"London", description:"", party_size: 20, service: chef, min_price: 240, max_price: 300, user_id: louise.id)
event16 =  Event.create!(name:"Fashion blogger Event", date:"2018/12/05", event_type: "business event", location:"London", description:"", party_size: 60, service: chef, min_price: 350, max_price: 400, user_id: lisa.id)
event17 =  Event.create!(name:"Launch party", date:"2018/12/01", event_type: "launch party", location:"London", description:"", party_size: 40, service: chef, min_price: 200, max_price: 300, user_id: andrew.id)
event18 =  Event.create!(name:"Sweet 16", date:"2018/12/20", event_type: "party", location:"London", description:"", party_size: 16, service: chef, min_price: 225, max_price: 300, user_id: louise.id)
event19 =  Event.create!(name:"New Years Eve Party", date:"2018/12/31", event_type: "new years", location:"London", description:"", party_size: 50, service: mixologist, min_price: 150, max_price: 300, user_id: andrew.id)
event20 =  Event.create!(name:"Engagement Party", date:"2018/09/01", event_type: "Engagement", location:"London", description:"", party_size: 50, service: mixologist, min_price: 260, max_price: 350, user_id: john.id)
event21 =  Event.create!(name:"Baby shower", date:"2018/11/17", event_type: "summer", location:"London", description:"", party_size: 50, service: waiter, min_price: 100, max_price: 150, user_id: lisa.id)
event22 =  Event.create!(name:"Summer Party", date:"2018/08/17", event_type: "tea party", location:"London", description:"", party_size: 50, service: chef, min_price: 150, max_price: 200, user_id: andrew.id)
event23 =  Event.create!(name:"Tea party", date:"2018/07/08", event_type: "tea party", location:"London", description:"", party_size: 50, service: mixologist, min_price: 200, max_price: 300, user_id: andrew.id)
