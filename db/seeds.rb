...
event18 =  Event.create!(name:"Sweet 16", date:"2019/12/20", event_type: "party", location:"London", description:"I'm open to suggestions", party_size: 16, service: chef, min_price: 225, max_price: 300, user_id: andrew.id)
