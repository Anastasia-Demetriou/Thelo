...
event7 =  Event.create!(name:"Birthday Dinner", date:"2018/01/19", event_type: "birthday", location:"London", description:"I'm open to suggestions", party_size: 10, service: chef, min_price: 1, max_price: 5, user_id: andrew.id)
...
event10 =  Event.create!(name:"Birthday party", date:"2018/12/29", event_type: "party", location:"London", description:"I'm open to suggestions", party_size: 17, service: chef, min_price: 100, max_price: 250, user_id: andrew.id)
event12 =  Event.create!(name:"Reunion Dinner", date:"2018/12/05", event_type: "Dinner", location:"London", description:"I'm open to suggestions", party_size: 10, service: chef, min_price: 250, max_price: 400, user_id: louise.id)
event13 =  Event.create!(name:"30th Birthday!", date:"2018/12/19", event_type: "birthday", location:"London", description:"I'm open to suggestions", party_size: 13, service: mixologist, min_price: 150, max_price: 250, user_id: andrew.id)
event14 =  Event.create!(name:"Fred's Farewell", date:"2018/12/17", event_type: "family event", location:"London", description:"I'm open to suggestions", party_size: 10, service: chef, min_price: 150, max_price: 300, user_id: andrew.id)
event15 =  Event.create!(name:"Welcome Home party", date:"2019/12/10", event_type: "family event", location:"London", description:"I'm open to suggestions", party_size: 20, service: chef, min_price: 240, max_price: 300, user_id: louise.id)
event16 =  Event.create!(name:"Fashion blogger Event", date:"2019/12/05", event_type: "business event", location:"London", description:"I'm open to suggestions", party_size: 60, service: chef, min_price: 350, max_price: 400, user_id: lisa.id)
event17 =  Event.create!(name:"Launch party", date:"2019/12/01", event_type: "launch party", location:"London", description:"I'm open to suggestions", party_size: 40, service: chef, min_price: 200, max_price: 300, user_id: andrew.id)
...
event19 =  Event.create!(name:"New Years Eve Party", date:"2018/12/31", event_type: "new years", location:"London", description:"I'm open to suggestions", party_size: 50, service: mixologist, min_price: 150, max_price: 300, user_id: andrew.id)
event20 =  Event.create!(name:"Engagement Party", date:"2019/09/01", event_type: "Engagement", location:"London", description:"I'm open to suggestions", party_size: 50, service: mixologist, min_price: 260, max_price: 350, user_id: john.id)
event21 =  Event.create!(name:"Baby shower", date:"2019/11/17", event_type: "summer", location:"London", description:"I'm open to suggestions", party_size: 50, service: waiter, min_price: 100, max_price: 150, user_id: lisa.id)
event22 =  Event.create!(name:"Summer Party", date:"2019/08/17", event_type: "tea party", location:"London", description:"I'm open to suggestions", party_size: 50, service: chef, min_price: 150, max_price: 200, user_id: andrew.id)
event23 =  Event.create!(name:"Tea party", date:"2019/07/08", event_type: "tea party", location:"London", description:"I'm open to suggestions", party_size: 50, service: mixologist, min_price: 200, max_price: 300, user_id: andrew.id)
